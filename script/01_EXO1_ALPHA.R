#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#
# EXAMPLE 1 : ALPHA DIVERSITY - RICHNESS, SHANNON, INV SIMPSON----
#
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
abundance_table <- "exo1_16S.txt"
metadata_file <- "exo1_metadata_16S.txt"
...
p1
# ALPHA DIVRESITY----
sample_sums(ps) %>% range()
ps_rare <- rarefy_even_depth(ps, rngseed = 20190124)
p2 <- plot_richness(ps_rare, x = "Step", color = "Step",
